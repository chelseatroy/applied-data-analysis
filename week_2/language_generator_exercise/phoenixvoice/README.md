...
The function returns the path to the output file. The filename is derived from the
URL domain, so `https://chelseatroy.com` produces `chelseatroy_com_blog_posts.txt`.
